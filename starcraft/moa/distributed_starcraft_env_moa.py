...
class StarCraft_Worker:
    def __init__(self, size, env_params, time_penalty, device='cpu'):
        ...
        self.device=device
        self.model = Combined_StarCraft_Helper(device=device, env_name=env_params['map_name'])
        self.model.eval()
    ...
    def get_action_from_model(self, input_obs, available_actions, adj_matrix):
        ...
        output_action_dist, state_vals = self.model.get_actions(observation_list, available_actions_list)
