...
class Batch_Storage:
    ...
    def add_to_batch(self, worker_ix, dones, log_probs, state_vals, rewards):
        ...
        for temp_ix, add_index in enumerate(add_indeces):
            self.batch_storage[start_ix+add_index].append([log_probs[temp_ix], state_vals[temp_ix], rewards[temp_ix]])
